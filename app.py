...
# azure key vault secret collection
key_vault_url = "https://webapp-aks-kv.vault.azure.net/"
...
password_secret = secret_client.get_secret("server-passwrd")
...
print(f"ser:{server}, db:{database}, user:{username}, pass:{password}")
